...
@section('master_landing_content')
@php
$about_details= DB::table('about_sections')->get();
@endphp
<main id="main">
    <!-- ======= About Section ======= -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        @foreach($about_details as $about)
          <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              <h3>{{ $about->question_title}}</h3>
              <h2>{{ $about->title}}</h2>
              <p>
              {{ $about->description}}
              </p>
              <div class="text-center text-lg-start">
                <a href="{{ route('more.about')}}" class="btn-read-more d-inline-flex align-items-center justify-content-center align-self-center">
                  <span>Know More</span>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="clients-slider swiper-container">
          <div class="swiper-wrapper align-items-center">
              @foreach($brands as $brand_img)
            <div class="swiper-slide"><img src="{{ $brand_img->brand_image }}" width="70px" height="70px" class="img-fluid" alt=""></div>
            @endforeach
          </div>
          <div class="swiper-pagination"></div>
        </div>
