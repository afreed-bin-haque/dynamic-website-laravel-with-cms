...
<html lang="en" dir="ltr">
  ...
  <title>CuatroDEV Test CMS Dashboard</title>
              ...
              <div class="navbar-right ">
                <ul class="nav navbar-nav">
                  ...
                  <li class="github-link mr-3">
                    <a class="btn btn-outline-primary btn-sm" href="{{ route('/') }}" target="_blank">
                      <span class="d-none d-md-inline-block mr-2">Go to your Website</span>
                    </a>
