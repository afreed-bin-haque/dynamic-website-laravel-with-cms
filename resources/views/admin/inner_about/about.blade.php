...
<div class="container">
 ...
 @endif
    ...
    <h2 class="font-semibold text-xl text-gray-800 leading-tight nounderline">Card table</h2>
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-hover" style="background-color: #5931a4;color:white">
                                ...
                                <tbody>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td><img src="" alt="Brand Image" width="40px" height="80px"></td>
                                    ...
                                    <td><a href="" class="btn btn-sm btn-outline-light text-warning" style="border-radius: 25px;color:#f48c06">Edit</a>
                                    <a href="" class="btn btn-sm btn-outline-danger text-white" style="border-radius: 25px;color:#d90429" onclick="return confirm('Are you sure to delete this brand?')">Delete</a>
                                    </td>
                                    </tr>
